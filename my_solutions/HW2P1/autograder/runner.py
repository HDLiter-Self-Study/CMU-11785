...
def test_upsampling_1d_correctness():
    ...
    expected_res = np.load("autograder/ref_result/upsample_1d_res.npz", allow_pickle=True)
...
def test_downsampling_1d_correctness():
    ...
    expected_res = np.load("autograder/ref_result/downsample_1d_res.npz", allow_pickle=True)
...
def test_upsampling_2d_correctness():
    ...
    expected_res = np.load("autograder/ref_result/upsample_2d_res.npz", allow_pickle=True)
...
def test_downsampling_2d_correctness():
    ...
    expected_res = np.load("autograder/ref_result/downsample_2d_res.npz", allow_pickle=True)
...
def conv2d_correctness():
    ...
    test_model = Conv2d(
        in_c, out_c, kernel, stride, padding=padding, weight_init_fn=random_normal_weight_init_fn, bias_init_fn=np.zeros
    )
...
def test_convTranspose_1d_correctness():
    ...
    for __ in seeds:
        ...
        conv_transpose_1d = ConvTranspose1d(
            in_c, out_c, kernel, upsampling_factor, weight_init_fn=weight_init_fn, bias_init_fn=bias_init_fn
        )
    ...
    expected_res = np.load("autograder/ref_result/convTranspose_1d_res.npz", allow_pickle=True)
...
def test_convTranspose_2d_correctness():
    ...
    for __ in seeds:
        ...
        conv_transpose_2d = ConvTranspose2d(
            in_c, out_c, kernel, upsampling_factor, weight_init_fn=weight_init_fn_2d, bias_init_fn=bias_init_fn
        )
    ...
    expected_res = np.load("autograder/ref_result/convTranspose_2d_res.npz", allow_pickle=True)
...
def test_MaxPool2d_stride1_correctness():
    ...
    expected_res = np.load("autograder/ref_result/maxpool2d_stride1_res.npz", allow_pickle=True)
...
def test_MaxPool2d_correctness():
    ...
    expected_res = np.load("autograder/ref_result/maxpool2d_res.npz", allow_pickle=True)
...
def test_simple_scanning_mlp():
    data = np.loadtxt(os.path.join("autograder", "data", "data.asc")).T.reshape(1, 24, -1)
    cnn = cnn_solution.CNN_SimpleScanningMLP()
    weights = np.load(os.path.join("autograder", "weights", "mlp_weights_part_b.npy"), allow_pickle=True)
    cnn.init_weights(weights)

    expected_result = np.load(os.path.join("autograder", "ref_result", "res_b.npy"), allow_pickle=True)
...
def test_distributed_scanning_mlp():
    ...
    weights = np.load(os.path.join("autograder", "weights", "mlp_weights_part_c.npy"), allow_pickle=True)
    cnn.init_weights(weights)

    expected_result = np.load(os.path.join("autograder", "ref_result", "res_c.npy"), allow_pickle=True)
...
def cnn_model_correctness(idx):
    ...
    data = np.loadtxt(os.path.join("autograder", "data", "data.asc")).T.reshape(1, 24, -1)
    labels = np.load(os.path.join("autograder", "data", "labels.npy"), allow_pickle=True)
