...
class CNN_DistributedScanningMLP:
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        self.conv1.conv1d_stride1.W = w1.T[:2, : 2 * 24].reshape((2, 2, 24)).transpose((0, 2, 1))
        self.conv2.conv1d_stride1.W = w2.T[:8, : 2 * 2].reshape((8, 2, 2)).transpose((0, 2, 1))
        self.conv3.conv1d_stride1.W = w3.T[:4, : 2 * 8].reshape((4, 2, 8)).transpose((0, 2, 1))
